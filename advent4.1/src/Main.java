...
public class Main {
    ...
    /**
     * Check if the provided number has to adjacent digits (for example: 111111, 123455, but not 123456)
     *
    ...
    private static boolean checkIfNumberHasTwoAdjacentDigits(int number) {
        ...
        return uglyButEasy.contains("00") || uglyButEasy.contains("11") || uglyButEasy.contains("22") || uglyButEasy.contains("33") || uglyButEasy.contains("44") ||
                uglyButEasy.contains("55") || uglyButEasy.contains("66") || uglyButEasy.contains("77") || uglyButEasy.contains("88") || uglyButEasy.contains("99");
    }
